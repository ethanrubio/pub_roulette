...
const yelp = new Yelp({
  consumer_key: keys.yelp.consumer_key || process.env.YELP_CONSUMER_KEY,
  consumer_secret: keys.yelp.consumer_secret || process.env.YELP_CONSUMER_SECRET,
  token: keys.yelp.token || process.env.YELP_TOKEN,
  token_secret: keys.yelp.token_secret || process.env.YELP_TOKEN_SECRET,
});
